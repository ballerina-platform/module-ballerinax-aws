...
public final class ErrorUtils {
    ...
    /**
     * Builds an {@code ErrorDetails} record from the given exception, populating the AWS
     * service error fields when {@code exception} is an {@link AwsServiceException} carrying
     * {@link AwsErrorDetails}; otherwise the record is returned with all fields unset.
     */
    public static BMap<BString, Object> createErrorDetails(Throwable exception) {
        BMap<BString, Object> errorDetails = ValueCreator.createRecordValue(ModuleUtils.getModule(), ERROR_DETAILS);
